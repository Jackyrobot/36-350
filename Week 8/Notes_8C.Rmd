...
<center>![](http://www.stat.cmu.edu/~mfarag/350/julia.png)</center>
...
There are 28 different `expect_<something>()` functions in the current version of `testthat`. Some not mentioned above include:
