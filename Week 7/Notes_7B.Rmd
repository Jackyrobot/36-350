...
<center>![](http://www.stat.cmu.edu/~mfarag/350/global.png){width=600px}</center>
...
Note that this is related to methods of *convex optimization*, which are beyond the scope of this class. For more details on convex optimization using `R`, see [this 2014 paper in the Journal of Statistical Software](http://www.stat.cmu.edu/~mfarag/350/ConvexOpt.pdf) by Roger Koenker and Ivan Mizera.

Global Optimization: a Plethora of Options
===

For an overview of global optimization methods in `R`, see [this 2014 paper in the Journal of Statistical Software](http://www.stat.cmu.edu/~mfarag/350/GlobalOpt.pdf) by Katherine Mullen.
